...
public class ReservaAlimentacionDialog extends AbstractAEPTitleAreaDialog
	...
	private ReservaAlimento reserva;
	private Shell shell;
	
	public ReservaAlimentacionDialog(Shell parentShell, LineaActividad linea,
			ReservaAlimento reserva) {
		super(parentShell);
		this.shell = parentShell;
		this.linea = linea;
		if (reserva == null) {
			isNuevaReserva = true;
			this.reserva = new ReservaAlimento();
		} else {
	...
	protected void llenarCampos() {
		if (isNuevaReserva) {
			setTitle("Nueva reserva de alimentación");
			...
			setTitle("Editando reserva de alimentación");
