...
public class CotizacionesEditorV3 extends AbstractEditorH {
	...
	private ComboData comboDataRedes;
...
//	private GridData gridData_2;
	...
	public CotizacionesEditorV3() {
		...
		comboDataRedes = cdController.getComboDataRedes();
	}
...
//	}
	...
	private void crearControlesTabGeneral(Composite parent) {
		...
		lblTour.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false, false, 1, 1));
		lblTour.setText("Tour:");
		
		txtTour = new Text(grupoTop, SWT.BORDER);
		GridData gd_txtTour = new GridData(60, 15);
		gd_txtTour.horizontalAlignment = SWT.LEFT;
		gd_txtTour.horizontalSpan = 1;
		txtTour.setLayoutData(gd_txtTour);
		txtTour.addModifyListener(this.createModifyListener());
		...
		gd_lblFechaFin.horizontalIndent = 15;
		...
		gd_lblVendedor.horizontalIndent = 15;
		lblVendedor.setLayoutData(gd_lblVendedor);
		lblVendedor.setText("Vendedor:");
		comboVendedor = new Combo(grupoTop, SWT.READ_ONLY);
		comboVendedor.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, false, false, 3, 1));
...
// ******************* Grupo de cliente asignado ***************************
		...
		new Label(grupoCliente, SWT.NONE);
		new Label(grupoCliente, SWT.NONE);
		
		Label lblRedViajes = new Label(grupoCliente, SWT.NONE);
		lblRedViajes.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false, false, 1, 1));
		lblRedViajes.setText("Red de viajes:");
		
		Combo comboRedViajes = new Combo(grupoCliente, SWT.READ_ONLY);
		comboRedViajes.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, true, false, 2, 1));
		comboRedViajes.setItems(comboDataRedes.getTexto());
