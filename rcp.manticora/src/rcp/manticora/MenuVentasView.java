...
import rcp.manticora.views.CotizacionesCanceladasView;
...
import rcp.manticora.views.HojasVentasNuevasView;
import rcp.manticora.views.ProductosView;
import rcp.manticora.views.SolicitudesAsignadasView;
import rcp.manticora.views.SolicitudesCanceladasView;
import rcp.manticora.views.SolicitudesNuevasView;
import rcp.manticora.views.SolicitudesProcesadasView;
import rcp.manticora.views.SolicitudesView;

public class MenuVentasView extends ViewPart {
	public static final String ID = "manticora.menuVentasView";
	...
	private TreeObject crearMenu() {
		...
		p2.addChild(new TreeObject("Asignadas", SolicitudesAsignadasView.ID, "icons/menuVentas.gif"));
		p2.addChild(new TreeObject("Procesadas", SolicitudesProcesadasView.ID, "icons/menuVentas.gif"));
		p2.addChild(new TreeObject("Canceladas", SolicitudesCanceladasView.ID, "icons/menuVentas.gif"));
		
		TreeParent p3 = new TreeParent("Cotizaciones");
		p3.addChild(new TreeObject("Nuevas", CotizacionesActivasView.ID, "icons/menuOperaciones.gif"));
		p3.addChild(new TreeObject("Procesadas", CotizacionesProcesadasView.ID, "icons/menuOperaciones.gif"));
		p3.addChild(new TreeObject("Canceladas", CotizacionesCanceladasView.ID, "icons/menuOperaciones.gif"));
		p3.addChild(new TreeObject("Pago parcial", CotizacionesParcialView.ID, "icons/menuOperaciones.gif"));

		TreeParent p4 = new TreeParent("Hojas de servicio");
		p4.addChild(new TreeObject("Nuevas", HojasVentasNuevasView.ID, "icons/menuOperaciones.gif"));
		p4.addChild(new TreeObject("En proceso", HojasEnProcesoView.ID, "icons/menuOperaciones.gif"));
