...
public class CotizacionesContabilidadView extends AbstractViewH implements IViewFilter {
	public static final String ID = "manticora.cotizacionesContabilidadView";
	private ViewController controller;
	private Table tabla;
	private TableViewer viewer;

	public CotizacionesContabilidadView() {
		super();
	...
	public void crearTabla(Composite parent) {
		...
		column = new TableColumn(tabla, SWT.CENTER);
	...
	class ViewLabelProvider extends LabelProvider implements ITableLabelProvider {
		...
		public Image getColumnImage(Object obj, int index) {
			...
			switch (index) {
			case 0:
				if (c.getFechaContabilidad() != null) {
