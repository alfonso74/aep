...
public class HojasEnProcesoView extends AbstractViewH {
	public static final String ID = "manticora.hojasEnProcesoView";
	private ViewController controller;
	private Table tabla;
	private TableViewer viewer;
	
	public HojasEnProcesoView() {
		super();
	...
	public void createPartControl(Composite parent) {
		...
		viewer.setInput(controller.getListadoHojasByStatus("P"));
