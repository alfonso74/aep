...
public class ClientesView extends ViewPart implements IRefreshView, IViewFilter {
	public static final String ID = "manticora.views.clientesView";
	private Table tabla;
	...
	public void createPartControl(Composite parent) {
		...
		viewer.setInput(controller.getListadoClientesByClase(Cliente.Clase.NATURAL));
		...
		viewer.addDoubleClickListener(new IDoubleClickListener() {
			public void doubleClick(DoubleClickEvent event) {
				...
				try {
					...
					getSite().getPage().openEditor(input, ClientesEditor.ID);	
