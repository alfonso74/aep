...
public class HojasView extends AbstractViewH {
	public static final String ID = "manticora.hojasView";
	...
	public void createPartControl(Composite parent) {
		...
		viewer.setInput(controller.getListadoHojas());
