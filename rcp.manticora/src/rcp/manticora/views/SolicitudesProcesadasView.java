...
public class SolicitudesProcesadasView extends ViewPart implements IRefreshView {
	public static final String ID = "manticora.solicitudesProcesadasView";
	private Table tabla;
	private TableViewer viewer;
	private ViewController controller;

	public SolicitudesProcesadasView() {
		super();
	...
	public void createPartControl(Composite parent) {
		...
		viewer.setInput(controller.getListadoSolicitudesByStatus("P"));
