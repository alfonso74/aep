...
public class HojasFinalizadasView extends AbstractViewH {
	public static final String ID = "manticora.hojasFinalizadasView";
	private ViewController controller;
	private Table tabla;
	private TableViewer viewer;
	
	public HojasFinalizadasView() {
		super();
	...
	public void createPartControl(Composite parent) {
		...
		viewer.setInput(controller.getListadoHojasByStatus("F"));
