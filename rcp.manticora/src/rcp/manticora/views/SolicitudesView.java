...
import rcp.manticora.services.SolicitudesByStatus;

public class SolicitudesView extends ViewPart implements IRefreshView {
	public static final String ID = "manticora.solicitudesView";
	private Table tabla;
	...
	public void createPartControl(Composite parent) {
		...
		viewer.setInput(controller.getListadoSolicitudes());
	...
	public void agregarFiltroByStatus(String estado) {
		this.setPartName("Solicitudes x status");
		viewer.addFilter(new SolicitudesByStatus(estado));
		viewer.refresh();
	}
