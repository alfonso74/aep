...
public class CotizacionesActivasView extends ViewPart implements IRefreshView, IViewFilter {
	public static final String ID = "manticora.cotizacionesActivasView";
	private ViewController controller;
	private Table tabla;
	private TableViewer viewer;

	public CotizacionesActivasView() {
		super();
	...
	public void createPartControl(Composite parent) {
		...
		viewer.setInput(controller.getListadoCotizacionesByStatus("A"));
	...
	public void crearTabla(Composite parent) {
		...
		column = new TableColumn(tabla, SWT.CENTER, 6);
		column.setText("Creada");
		column.setWidth(75);
	}
	...
	class ViewLabelProvider extends LabelProvider implements ITableLabelProvider {
		public String getColumnText(Object obj, int index) {
			...
			case 5:
				...
				break;
			case 6:
				resultado = FechaUtil.toString(c.getFechaCreacion());
				break;
			}
			return resultado;
		}
