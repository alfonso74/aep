...
import rcp.manticora.services.CotizacionesPagoParcial;
import rcp.manticora.services.FechaUtil;
import rcp.manticora.services.GenericSorter;

public class CotizacionesParcialView extends ViewPart implements IRefreshView {
	public static final String ID = "manticora.cotizacionesParcialView";
	private ViewController controller;
	private Table tabla;
	private TableViewer viewer;

	public CotizacionesParcialView() {
		super();
	...
	public void createPartControl(Composite parent) {
		...
		viewer.addFilter(new CotizacionesPagoParcial());
