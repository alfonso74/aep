...
public class CotizacionesProcesadasView extends ViewPart implements IRefreshView {
	public static final String ID = "manticora.cotizacionesProcesadasView";
	private ViewController controller;
	private Table tabla;
	private TableViewer viewer;

	public CotizacionesProcesadasView() {
		super();
	...
	public void createPartControl(Composite parent) {
		...
		viewer.setInput(controller.getListadoCotizacionesByStatus("P"));
