...
public class HojasVentasNuevasView extends AbstractViewH {
	public static final String ID = "manticora.hojasVentasNuevasView";
	private ViewController controller;
	private Table tabla;
	private TableViewer viewer;
	
	public HojasVentasNuevasView() {
		super();
	...
	public void createPartControl(Composite parent) {
		...
		viewer.setInput(controller.getListadoHojasVentasByStatus("N"));
