...
public class SolicitudesCanceladasView extends ViewPart implements IRefreshView {
	public static final String ID = "manticora.solicitudesCanceladasView";
	private Table tabla;
	private TableViewer viewer;
	private ViewController controller;

	public SolicitudesCanceladasView() {
		super();
	...
	public void createPartControl(Composite parent) {
		...
		viewer.setInput(controller.getListadoSolicitudesByStatus("C"));
